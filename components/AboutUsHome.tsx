  ...
  return (
    <div className='w-full'>
      <div className='text-center w-11/12 mx-auto max-w-6xl py-20' id='about'>
          ...
          <p className='para mb-6 text-sm sm:text-base leading-[26px]'>Lansel Trading is a reputable company established in Ethiopia, dedicated to delivering high-quality office materials and supplies to
