...
//         <h1 className='sectionName w-28 mx-auto'>Our Services</h1>
...
//             {/* Left Text Card */}
//             <div className='primaryBg flex flex-col justify-center items-center p-5 w-full rounded-xl order-1 lg:order-0'>
//               <h4 className='text-white text-2xl font-bold'>Chemical Distribution</h4>
//               <Link href={'/aboutus'} className='mx-auto btn text-black font-bold flex items-center text-nowrap'>
//                 See More&nbsp;<MdOutlineArrowOutward />
//               </Link>
//             </div>

//             {/* Swiper on Small/Medium Screens */}
//             <div className='w-full relative block lg:hidden'>
//               <div className='swiper-button-prev-custom absolute top-1/2 -left-2 z-10 transform -translate-y-1/2 cursor-pointer primaryBg text-white font-bold p-1 rounded-full shadow'>
//                 <HiChevronLeft size={24} />
//               </div>
//               <div className='swiper-button-next-custom absolute top-1/2 -right-2 z-10 transform -translate-y-1/2 cursor-pointer primaryBg text-white font-bold p-1 rounded-full shadow'>
...
//             <div className='w-full hidden lg:grid grid-cols-3 gap-5 lg:order-1'>
//               {chemicalProducts.map((item, index) => (
...
//             {/* Left Text Card */}
//             <div className='primaryBg flex flex-col justify-center items-center p-5 w-full rounded-xl order-1 lg:order-1'>
...
//             {/* Grid on Large Screens */}
//             <div className='w-full hidden lg:grid grid-cols-3 gap-5 lg:order-0'>
//               {officeProducts.map((item, index) => (
//                 <Products key={index} title={item.title} image={item.image} />
//               ))}
//             </div>
