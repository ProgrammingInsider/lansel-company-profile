...
const AboutUs = () => {
  return (
    <div className='grid md:grid-cols-5 text-center md:text-left w-11/12 mx-auto max-w-6xl py-20 gap-5'>
      <div className='w-full h-[75vh] col-span-3 flex flex-col gap-5 order-1 md:order-0'>
      ...
      <div className='flex flex-col items-center md:items-left w-11/12 mx-auto max-w-6xl col-span-2 md:order-1'>
          <h1 className='sectionName w-28 md:ml-5'>Our Story</h1>
          <h1 className='sectionHeader md:text-left'>Lansel Trading</h1>
